...
@router.get("/api/produce/", 
    response_model=list[Produce_get])
def get_all_produce(queries: ProduceQueries = 
    Depends()):
...
@router.get("/api/produce/{produce_id}", 
    response_model=Optional[Produce_get])
...
@router.put("/api/produce/{produce_id}/put", 
    response_model=Union[Produce_get, Error])
def update_produce(
    produce_id: int,
    produce: Produce_create,
    queries: ProduceQueries = Depends(),
...
@router.delete("/api/produce/{produce_id}/delete", 
    response_model=bool)
def delete_produce(
    produce_id: int,
    queries: ProduceQueries = Depends(),
...
@router.patch("/api/produce/{produce_id}/patch", 
    response_model=Produce_get)
