...
function ProduceItemEdit(props) {
  ...
  const handleSubmit = (e) => {
    ...
    fetch(
      `${process.env.REACT_APP_API_HOST_MONOLITH}/api/produce/${props.produce_id}/patch`,
      {
        method: "PATCH",
        headers: {
        ...
        <form className="FormSubmit" onSubmit={handleSubmit}>
          <div className="mb-3">
            ...
            <input
              ...
              onChange={(pn) => setProductName(pn.target.value)}
              type="text"
          ...
          <input
            type="file"
            defaultValue={item.picture_file}
          ...
          <div className="form-floating mb-3">
            ...
            <input
              ...
              onChange={(w) => setWidth(w.target.value)}
              placeholder="width"
              required
              type="number"
              name="width"
