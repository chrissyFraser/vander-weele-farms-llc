...
function HomePage() {
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src={require("./images/produce.png")}  class="d-block w-100" alt="pic1"/>
    </div>
    <div class="carousel-item">
      <img src={require("./images/rhubarb.jpeg")}  class="d-block w-100" alt="pic2"/>
    </div>
    <div class="carousel-item">
      <img src={require("./images/deliverytruck.png")}  class="d-block w-100" alt="pic3"/>
    </div>
  </div>
