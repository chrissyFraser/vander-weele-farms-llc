...
function UserInfoComponent() {
    ...
    async function createCustomer(customer_name, customer_address, customer_email, priority_id, driver_id) {
    ...
    const submitHandler = e => {
        ...
        createCustomer(customer_name, customer_address, customer_email, priority_id, driver_id)
        e.preventDefault();
