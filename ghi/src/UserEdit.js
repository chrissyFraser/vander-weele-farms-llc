...
function UserUpdateComponent() {
    ...
    async function updateUser(customer_name, customer_address, customer_email, driver_id, priority_id) {
        ...
        const murl = `${process.env.REACT_APP_API_HOST_MONOLITH}/api/customers`;
    ...
    const submitHandler = e => {
        ...
        e.preventDefault();
        console.log("Form information", userName, customer_address, userEmail)
    ...
    return (
        <div>
            <center>
                <h2>Please enter your address for orders</h2>
